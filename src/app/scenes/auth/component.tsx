...
class AuthView extends React.Component<IAuthViewProps> {
  ...
  public renderSignInView = CSSModules(() => this.getSignInView(), styles, { allowMultiple: true });
  public renderSignUpView = CSSModules(() => this.getSignUpView(), styles, { allowMultiple: true });
